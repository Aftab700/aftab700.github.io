---
title: "Internal Hiring Challenge Machine WriteUp"
description: "This is about exploiting a virtual machine using Blackbox Testing, which I successfully completed as part of a hiring challenge."
...
**Challenge Description**: _Download the VM and start it. It has a web application hosted which is configured to boot at start so you can put the VM in the background. Simply find the address of the application and start pentesting._


**Challenge Goal**: _Find the file `flag.txt` and read its content._
...
We have to create polyglot PHP/JPG payload. how i do it is open jpg file and append php payload at last so let's create [simple.php](https://github.com/Aftab700/Writeups/raw/1178fdf5b724e5cc90df7a446909b259811273b4/Others/files/simple.php) payload.
...
[revshell.php](https://github.com/Aftab700/Writeups/raw/1178fdf5b724e5cc90df7a446909b259811273b4/Others/files/revshell.php)
